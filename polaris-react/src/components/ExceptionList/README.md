...
- ![Exception list being used inside a resource list item](/images/exception-list/do-exception-list@2x.png)

#### Don’t

- ![Exception list being used in place of a banner](/images/exception-list/dont-exception-list@2x.png)
