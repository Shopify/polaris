...
import type {ResponsiveValue} from './Boxo.css';
import {mapResponsiveValue, atoms} from './Boxo.css';
import styles from './Boxo.scss';
...
export interface BoxoProps extends React.AriaAttributes {
...
export const Boxo = forwardRef<HTMLElement, BoxoProps>(
  (
    {
      as = 'div',
      background,
