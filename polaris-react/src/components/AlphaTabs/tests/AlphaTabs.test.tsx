...
import {AlphaTabs} from '..';
import type {AlphaTabProps, AlphaTabsProps} from '..';
...
describe('AlphaTabs', () => {
  ...
  const mockProps: AlphaTabsProps = {
    tabs,
    onSelect: jest.fn(),
    selected: 1,
  ...
  describe('focus management', () => {
    it('passes focus index to tab measurer', () => {
      ...
      const wrapper = mountWithApp(<AlphaTabs {...mockProps} tabs={tabs} />);
  ...
  describe('tabs', () => {
    it('uses the IDs passed in for the tabs', () => {
      const tabs: AlphaTabsProps['tabs'] = [
    ...
    it('uses the panelID passed in for the tabs', () => {
      ...
      const wrapper = mountWithApp(
        <AlphaTabs {...mockProps} tabs={panelIDedTabs}>
          {content}
        </AlphaTabs>,
      );
    ...
    it('uses an auto-generated panelID if none is provided', () => {
      const content = <p>Panel contents</p>;
      const wrapper = mountWithApp(
        <AlphaTabs {...mockProps}>{content}</AlphaTabs>,
      );
    ...
    it('sets the panelID to undefined when the tab does not have an associated panel (child)', () => {
      const wrapper = mountWithApp(<AlphaTabs {...mockProps} />);
    ...
    it('sets the tab URL if passed in the tab descriptor', () => {
      ...
      const wrapper = mountWithApp(<AlphaTabs {...mockProps} tabs={urlTabs} />);
    ...
    it('sets the accessibility label for each of the tabs', () => {
      ...
      const wrapper = mountWithApp(
        <AlphaTabs {...mockProps} tabs={labelledTabs} />,
      );
    ...
    it('sets the content for each of the tabs if given content', () => {
      ...
      const wrapper = mountWithApp(
        <AlphaTabs {...mockProps} tabs={tabsWithContent} />,
      );
  ...
  describe('onSelect()', () => {
    it('is called with the index of the clicked tab', () => {
      const spy = jest.fn();
      const wrapper = mountWithApp(<AlphaTabs {...mockProps} onSelect={spy} />);
  ...
  describe('<TabMeasurer />', () => {
    ...
    it('is not set to anything by default', () => {
      const tabs = mountWithApp(<AlphaTabs {...mockProps} tabs={mockTabs} />);
    ...
    it('passes the provided selected value if given', () => {
      const tabs = mountWithApp(
        <AlphaTabs {...mockProps} selected={1} tabs={mockTabs} />,
      );
    ...
    describe('ArrowRight', () => {
      it('shifts focus to the next tab when pressing ArrowRight', () => {
        const tabs = mountWithApp(
          <AlphaTabs {...mockProps} tabs={mockTabs} selected={0} />,
        );
  ...
  describe('canCreateNewView', () => {
    it('does not render the new tab Tab if canCreateNewView=false', () => {
      const wrapper = mountWithApp(
        <AlphaTabs {...mockProps} canCreateNewView={false} />,
      );
    ...
    it('renders the new tab Tab if canCreateNewView=true', () => {
      const wrapper = mountWithApp(
        <AlphaTabs {...mockProps} canCreateNewView />,
      );
