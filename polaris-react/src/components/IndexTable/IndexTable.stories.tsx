...
export function WithNestedRowsAndDynamicRows() {
  const initialRows = [
    {
      id: '3411',
      quantity: 11,
  ...
  function addRows() {
    setRows([...initialRows, ...additionalRows]);
  }
  ...
  return (
    <>
      <LegacyCard>
        <button onClick={addRows}>Add dynamic rows</button>
        <IndexTable
          condensed={useBreakpoints().smDown}
          onSelectionChange={handleSelectionChange}
          selectedItemsCount={
