...
![Image showing skeleton display text for dynamic content](/images/skeleton/do-show-display-text-for-static-content@2x.png)

#### Don’t

Use skeleton display text for static content or placeholder content for dynamic content.
![Image showing skeleton display text for static content and placeholder text for dynamic content](/images/skeleton/dont-use-skeleton-for-static-or-placeholder-content-for-dynamic@2x.png)
...
![Image showing skeleton display text for dynamic page title](/images/skeleton/do-use-skeleton-for-dynamic-page-titles@2x.png)
