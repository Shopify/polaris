...
- Removed high-contrast-outline() and high-contrast-border() mixins and replaced any instances with tokens and values ([#](https://github.com/Shopify/polaris-react/pull/))
