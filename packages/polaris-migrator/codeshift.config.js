...
module.exports = {
  presets: {
    ...
    'v11-styles-replace-custom-property-border': resolve(
      'v11-styles-replace-custom-property-border',
    ),
    'v11-styles-replace-custom-property-depth': resolve(
      'v11-styles-replace-custom-property-depth',
    ),
    'v11-styles-replace-custom-property-legacy': resolve(
      'v11-styles-replace-custom-property-legacy',
    ),
    'v11-styles-replace-custom-property-z-index': resolve(
      'v11-styles-replace-custom-property-z-index',
    ),
    'v10-react-replace-text-components': resolve(
    ...
    'v9-styles-replace-custom-property-border': resolve(
      'v9-styles-replace-custom-property-border',
    ),
    'v9-styles-replace-custom-property-depth': resolve(
      'v9-styles-replace-custom-property-depth',
    ),
    'v9-styles-replace-custom-property-font': resolve(
      'v9-styles-replace-custom-property-font',
    ),
    'v9-styles-replace-custom-property-legacy': resolve(
      'v9-styles-replace-custom-property-legacy',
    ),
    'v9-styles-replace-custom-property-motion': resolve(
