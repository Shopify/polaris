...
import {colorSchemeMap, getGithubUrl, nonColorSchemeTokenGroups} from './[tokens]';
            ...
            ${Object.keys(colorSchemeMap).map(colorScheme => {
                ...
                return `
                    <tr>
                        ...
                        <td>
                            <a href="${getGithubUrl(tokenGroup, false)}">File</a>
                        </td>
                    </tr>
                `;
            }).join('\n')}
            ${nonColorSchemeTokenGroups.map(tokenGroup => {
