...
1. [Tophat 🎩](https://github.com/Shopify/polaris/blob/main/documentation/Tophatting.md) your changes locally with `yarn dev`
...
- `yarn dev:react` runs a Storybook server which includes a playground editable at `playground/Playground.tsx`
