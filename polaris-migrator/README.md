...
Insert stylelint ignore comments for [stylelint-polaris](../stylelint-polaris/) warnings and errors so that existing failures
are not blocking a codebase from initializing the linter.

```diff
+ // stylelint-disable -- polaris: generated by polaris-migrator DO NOT COPY
