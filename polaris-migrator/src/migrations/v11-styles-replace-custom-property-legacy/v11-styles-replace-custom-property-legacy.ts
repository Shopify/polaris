...
const replacementMaps = {
  '/.+/': {
    ...
    '--p-choice-size': '20px', // 20px
    '--p-icon-size-small': '8px', // 8px
    '--p-icon-size-medium': '20px', // 20px
    ...
    '--p-text-field-spinner-offset': '2px', // 2px
    '--p-text-field-focus-ring-offset': '-4px', // -4px
    '--p-button-group-item-spacing': 'calc(-1 * var(--p-space-025))',
    '--p-range-slider-thumb-size-base': '16px', // 16px
    '--p-range-slider-thumb-size-active': '24px', // 24px
    '--p-frame-offset': '0',
  },
};
