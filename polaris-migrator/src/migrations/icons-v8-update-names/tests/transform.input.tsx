...
import {
  ...
  ActivityLogMajor,
  ActivityLogMinor,
  ActivityLogFilledMajor,
  ActivityLogFilledMinor,
  AddMajor,
  AddMinor,
  AddCodeMajor,
  AddCodeMinor,
  ...
  AnalyticsMajor,
  AnalyticsMinor,
  AnalyticsBarHorizontalMajor,
  AnalyticsBarHorizontalMinor,
  AnalyticsBarStackedMajor,
  AnalyticsBarStackedMinor,
  AnalyticsCohortMajor,
  AnalyticsCohortMinor,
  AnalyticsDonutMajor,
  AnalyticsDonutMinor,
  AnalyticsFilledMajor,
  AnalyticsFilledMinor,
  AnalyticsFunnelMajor,
  ...
  AttachmentFilledMinor,
  AutomationMajor,
  AutomationMinor,
  AutomationFilledMajor,
  AutomationFilledMinor,
  BackspaceMajor,
  BackspaceMinor,
  BalanceMajor,
  BalanceMinor,
  ...
  BillingStatementDollarMinor,
  BillingStatementDollarFilledMajor,
  BillingStatementDollarFilledMinor,
  BillingStatementEuroMajor,
  BillingStatementEuroMinor,
  BillingStatementEuroFilledMajor,
  BillingStatementEuroFilledMinor,
  BillingStatementPoundMajor,
  BillingStatementPoundMinor,
  BillingStatementPoundFilledMajor,
  BillingStatementPoundFilledMinor,
  BillingStatementRupeeMajor,
  BillingStatementRupeeMinor,
  BillingStatementRupeeFilledMajor,
  BillingStatementRupeeFilledMinor,
  BillingStatementYenMajor,
  BillingStatementYenMinor,
  BillingStatementYenFilledMajor,
  BillingStatementYenFilledMinor,
  BillPayMajor,
  BillPayMinor,
  BillPayFilledMajor,
  BillPayFilledMinor,
  ...
  ButtonCornerPillMinor,
  ButtonCornerRoundedMajor,
  ButtonCornerRoundedMinor,
  ButtonCornerSquareMajor,
  ButtonCornerSquareMinor,
  BuyButtonMajor,
  BuyButtonMinor,
  BuyButtonButtonLayoutMajor,
  BuyButtonButtonLayoutMinor,
  BuyButtonHorizontalLayoutMajor,
  BuyButtonHorizontalLayoutMinor,
  BuyButtonVerticalLayoutMajor,
  BuyButtonVerticalLayoutMinor,
  CalendarMajor,
  CalendarMinor,
  CalendarTickMajor,
  CalendarTickMinor,
  ...
  CircleCancelMajor,
  CircleCancelMinor,
  CircleChevronDownMajor,
  CircleChevronDownMinor,
  CircleChevronLeftMajor,
  CircleChevronLeftMinor,
  CircleChevronRightMajor,
  CircleChevronRightMinor,
  CircleChevronUpMajor,
  ...
  CircleInformationMinor,
  CircleLeftMajor,
  CircleLeftMinor,
  CircleMinusMajor,
  CircleMinusMinor,
  CircleMinusOutlineMajor,
  CircleMinusOutlineMinor,
  CirclePlusMajor,
  CirclePlusMinor,
  CirclePlusOutlineMajor,
  CirclePlusOutlineMinor,
  CircleRightMajor,
  CircleRightMinor,
  CircleTickMajor,
  CircleTickMinor,
  CircleTickOutlineMajor,
  ...
  CodeMajor,
  CodeMinor,
  CollectionReferenceMajor,
  CollectionReferenceMinor,
  CollectionsMajor,
  CollectionsMinor,
  CollectionsFilledMajor,
  CollectionsFilledMinor,
  ColorNoneMajor,
  ColorNoneMinor,
  ColorsMajor,
  ColorsMinor,
  ...
  CreditCardCancelMinor,
  CreditCardPercentMajor,
  CreditCardPercentMinor,
  CreditCardSecureMajor,
  CreditCardSecureMinor,
  CurrencyConvertMajor,
  ...
  CustomersMajor,
  CustomersMinor,
  CustomersFilledMajor,
  CustomersFilledMinor,
  DataDrivenModelMajor,
  ...
  DigitalMediaReceiverMinor,
  DiscountAutomaticMajor,
  DiscountAutomaticMinor,
  DiscountCodeMajor,
  DiscountCodeMinor,
  DiscountsMajor,
  DiscountsMinor,
  DiscountsFilledMajor,
  ...
  EmailNewsletterMinor,
  EmbedMajor,
  EmbedMinor,
  EnableSelectionMajor,
  ...
  FeaturedCollectionMinor,
  FeaturedContentMajor,
  FeaturedContentMinor,
  FileMajor,
  FileMinor,
  FileFilledMajor,
  FileFilledMinor,
  ...
  FulfillmentFulfilledMinor,
  FulfillmentOnHoldMajor,
  FulfillmentOnHoldMinor,
  GamesConsoleMajor,
  GamesConsoleMinor,
  GaugeMajor,
  GaugeMinor,
  ...
  LocationsMajor,
  LocationsMinor,
  LocationsInactiveMajor,
  LocationsInactiveMinor,
  LockMajor,
  LockMinor,
  LockFilledMajor,
  LockFilledMinor,
  ...
  MetafieldsMajor,
  MetafieldsMinor,
  MetafieldsFilledMajor,
  MetafieldsFilledMinor,
  MetaobjectMajor,
  MetaobjectMinor,
  MetaobjectFilledMajor,
  MetaobjectFilledMinor,
  MetaobjectReferenceMajor,
  ...
  MobileBackArrowMinor,
  MobileCancelMajor,
  MobileCancelMinor,
  MobileChevronMajor,
  MobileChevronMinor,
  MobileHamburgerMajor,
  MobileHamburgerMinor,
  MobileHorizontalDotsMajor,
  MobileHorizontalDotsMinor,
  MobilePlusMajor,
  MobilePlusMinor,
  MobileVerticalDotsMajor,
  MobileVerticalDotsMinor,
  MonerisMajor,
  MonerisMinor,
  MoneyMajor,
  MoneyMinor,
  ...
  PopularMajor,
  PopularMinor,
  PositionBasedModelMajor,
  PositionBasedModelMinor,
  PriceListMajor,
  PriceListMinor,
  PriceListFilledMajor,
  PriceListFilledMinor,
  PriceLookupMajor,
  PriceLookupMinor,
  PrintMajor,
  PrintMinor,
  ...
  ShippingLabelsMajor,
  ShippingLabelsMinor,
  ShippingLabelsFilledMajor,
  ShippingLabelsFilledMinor,
  ShopcodesMajor,
  ShopcodesMinor,
  SidebarLeftMajor,
  SidebarLeftMinor,
  ...
  TextAlignmentCenterMinor,
  TextAlignmentLeftMajor,
  TextAlignmentLeftMinor,
  TextAlignmentRightMajor,
  TextAlignmentRightMinor,
  TextBlockMajor,
  TextBlockMinor,
  TextColorMajor,
  TextColorMinor,
  ...
  TransactionFeeDollarMinor,
  TransactionFeeEuroMajor,
  TransactionFeeEuroMinor,
  TransactionFeePoundMajor,
  TransactionFeePoundMinor,
  TransactionFeeRupeeMajor,
  TransactionFeeRupeeMinor,
  TransactionFeeYenMajor,
  TransactionFeeYenMinor,
  TransferMajor,
  TransferMinor,
  TransferInMajor,
  TransferInMinor,
  ...
  TransferOutMinor,
  TransferFilledMajor,
  TransfersFilledMinor,
  TransferWithinShopifyMajor,
  TransferWithinShopifyMinor,
  TranslateMajor,
  TranslateMinor,
  TransportMajor,
  TransportMinor,
  ...
  UpdateInventoryMinor,
  UploadMajor,
  UploadMinor,
  UsersAndPermissionsMajor,
  UsersAndPermissionsMinor,
  UsersAndPermissionsFilledMajor,
  UsersAndPermissionsFilledMinor,
  VariantMajor,
  VariantMinor,
  ViewMajor,
  ViewMinor,
...
export function App() {
  return (
    <>
      ...
      <Icon source={FinancesFilledMajor} />
      <Icon source={FinancesFilledMinor} />
      <Icon source={FirstClickModelMajor} />
      <Icon source={FirstClickModelMinor} />
      <Icon source={FirstOrderMajor} />
      <Icon source={FirstOrderMinor} />
      <Icon source={FirstVisitMajor} />
      <Icon source={FirstVisitMinor} />
      <Icon source={FlagMajor} />
      <Icon source={FlagMinor} />
      <Icon source={FlipCameraMajor} />
      <Icon source={FlipCameraMinor} />
      <Icon source={FolderMajor} />
      <Icon source={FolderMinor} />
      <Icon source={FolderDownMajor} />
      <Icon source={FolderDownMinor} />
      <Icon source={FolderMinusMajor} />
      <Icon source={FolderMinusMinor} />
      <Icon source={FolderPlusMajor} />
      <Icon source={FolderPlusMinor} />
      <Icon source={FolderUpMajor} />
      <Icon source={FolderUpMinor} />
      <Icon source={FollowUpEmailMajor} />
      <Icon source={FollowUpEmailMinor} />
      <Icon source={FoodMajor} />
      <Icon source={FoodMinor} />
      <Icon source={FooterMajor} />
      <Icon source={FooterMinor} />
      <Icon source={FormsMajor} />
      <Icon source={FormsMinor} />
      ...
      <Icon source={OrdersFilledMajor} />
      <Icon source={OrdersFilledMinor} />
      <Icon source={OrderStatusMajor} />
      <Icon source={OrderStatusMinor} />
      <Icon source={OrganizationMajor} />
      <Icon source={OrganizationMinor} />
      <Icon source={OutdateMajor} />
      <Icon source={OutdateMinor} />
      <Icon source={OutdentMajor} />
      <Icon source={OutdentMinor} />
      <Icon source={OutgoingMajor} />
      <Icon source={OutgoingMinor} />
      <Icon source={PackageMajor} />
      <Icon source={PackageMinor} />
      ...
      <Icon source={QuickSaleMinor} />
      <Icon source={ReadTimeMajor} />
      <Icon source={ReadTimeMinor} />
      <Icon source={ReceiptMajor} />
      <Icon source={ReceiptMinor} />
      <Icon source={RecentSearchesMajor} />
      <Icon source={RecentSearchesMinor} />
      <Icon source={RedoMajor} />
      <Icon source={RedoMinor} />
      <Icon source={ReferralMajor} />
      <Icon source={ReferralMinor} />
      <Icon source={ReferralCodeMajor} />
      <Icon source={ReferralCodeMinor} />
      ...
      <Icon source={RemoveProductMinor} />
      <Icon source={RepeatOrderMajor} />
      <Icon source={RepeatOrderMinor} />
      <Icon source={ReplaceMajor} />
      <Icon source={ReplaceMinor} />
      <Icon source={ReplayMajor} />
      <Icon source={ReplayMinor} />
      <Icon source={ReportMajor} />
      <Icon source={ReportMinor} />
      <Icon source={ReportsMajor} />
      <Icon source={ReportsMinor} />
      <Icon source={ResetMajor} />
      <Icon source={ResetMinor} />
      <Icon source={ResourcesMajor} />
      <Icon source={ResourcesMinor} />
      <Icon source={ReturnMajor} />
      <Icon source={ReturnMinor} />
      <Icon source={ReturnsMajor} />
      <Icon source={ReturnsMinor} />
      <Icon source={RichTextMajor} />
      <Icon source={RichTextMinor} />
      <Icon source={RiskMajor} />
      <Icon source={RiskMinor} />
      <Icon source={Rows2Major} />
      <Icon source={Rows2Minor} />
      <Icon source={SandboxMajor} />
      <Icon source={SandboxMinor} />
      <Icon source={SaveMajor} />
      <Icon source={SaveMinor} />
      <Icon source={SearchMajor} />
      <Icon source={SearchMinor} />
      <Icon source={SectionMajor} />
      <Icon source={SectionMinor} />
      <Icon source={SecureMajor} />
      <Icon source={SecureMinor} />
      <Icon source={SelectMajor} />
      <Icon source={SelectMinor} />
      <Icon source={SendMajor} />
      <Icon source={SendMinor} />
      <Icon source={SettingsMajor} />
      <Icon source={SettingsMinor} />
      <Icon source={SettingsFilledMajor} />
      <Icon source={SettingsFilledMinor} />
      <Icon source={ShareMajor} />
      <Icon source={ShareMinor} />
      <Icon source={ShareIosMajor} />
      <Icon source={ShareIosMinor} />
      <Icon source={ShipmentMajor} />
      <Icon source={ShipmentMinor} />
      <Icon source={ShipmentFilledMajor} />
      <Icon source={ShipmentFilledMinor} />
      <Icon source={ShippingLabelsMajor} />
      <Icon source={ShippingLabelsMinor} />
      <Icon source={ShippingLabelsFilledMajor} />
      <Icon source={ShippingLabelsFilledMinor} />
      <Icon source={ShopcodesMajor} />
      <Icon source={ShopcodesMinor} />
      <Icon source={SidebarLeftMajor} />
      <Icon source={SidebarLeftMinor} />
      ...
      <Icon source={UnfulfilledMinor} />
      <Icon source={UnknownDeviceMajor} />
      <Icon source={UnknownDeviceMinor} />
      <Icon source={UpdateInventoryMajor} />
      <Icon source={UpdateInventoryMinor} />
      <Icon source={UploadMajor} />
      <Icon source={UploadMinor} />
      <Icon source={UsersAndPermissionsMajor} />
      <Icon source={UsersAndPermissionsMinor} />
      <Icon source={UsersAndPermissionsFilledMajor} />
      <Icon source={UsersAndPermissionsFilledMinor} />
      <Icon source={VariantMajor} />
      <Icon source={VariantMinor} />
      <Icon source={ViewMajor} />
      <Icon source={ViewMinor} />
      <Icon source={ViewportNarrowMajor} />
      <Icon source={ViewportNarrowMinor} />
      <Icon source={ViewportShortMajor} />
      <Icon source={ViewportShortMinor} />
      <Icon source={ViewportTallMajor} />
      <Icon source={ViewportTallMinor} />
      <Icon source={ViewportWideMajor} />
      <Icon source={ViewportWideMinor} />
      <Icon source={VimeoMajor} />
      <Icon source={VimeoMinor} />
      <Icon source={VocabularyMajor} />
      <Icon source={VocabularyMinor} />
      <Icon source={VolumeMajor} />
      <Icon source={VolumeMinor} />
      <Icon source={WandMajor} />
      <Icon source={WandMinor} />
      <Icon source={WearableMajor} />
      <Icon source={WearableMinor} />
      <Icon source={WeightMajor} />
      <Icon source={WeightMinor} />
      <Icon source={WholesaleMajor} />
      <Icon source={WholesaleMinor} />
      <Icon source={WifiMajor} />
      <Icon source={WifiMinor} />
      <Icon source={YoutubeMajor} />
