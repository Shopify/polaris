...
export const metaThemeLightUpliftPartial = createMetaThemePartial({
  ...
  color: {
    'color-surface': {value: colors.gray[1]},
    'color-surface-secondary': {value: colors.gray[4]},
    'color-surface-secondary-hover': {value: colors.gray[6]},
    'color-surface-secondary-active': {value: colors.gray[7]},
    'color-surface-tertiary': {value: colors.gray[5]},
    'color-fill-tertiary': {value: colors.gray[8]},
    'color-fill-tertiary-hover': {value: colors.gray[9]},
    'color-fill-tertiary-active': {value: colors.gray[10]},
    'color-input-surface': {value: colors.gray[2]},
    'color-input-surface-hover': {value: colors.gray[3]},
    'color-input-surface-active': {value: colors.gray[4]},
    'color-surface-selected': {value: colors.gray[3]},
    'color-fill-success': {value: colors.green[12]},
    'color-fill-success-hover': {value: colors.green[13]},
    'color-fill-success-active': {value: colors.green[14]},
    'color-fill-success-secondary': {value: colors.green[3]},
    'color-surface-success': {value: colors.green[3]},
    'color-surface-success-hover': {value: colors.green[4]},
    'color-surface-success-active': {value: colors.green[5]},
    'color-fill-critical': {value: colors.red[12]},
    'color-fill-critical-hover': {value: colors.red[13]},
    'color-fill-critical-active': {value: colors.red[14]},
    'color-fill-critical-secondary': {value: colors.red[6]},
    'color-surface-critical': {value: colors.red[4]},
    'color-surface-critical-hover': {value: colors.red[5]},
    'color-surface-critical-active': {value: colors.red[6]},
    'color-fill-caution': {value: colors.yellow[6]},
    'color-fill-caution-secondary': {value: colors.yellow[4]},
    'color-surface-caution': {value: colors.yellow[2]},
    'color-surface-caution-hover': {value: colors.yellow[3]},
    'color-surface-caution-active': {value: colors.yellow[4]},
    'color-fill-info': {value: colors.azure[9]},
    'color-fill-info-secondary': {value: colors.azure[4]},
    'color-surface-info': {value: colors.azure[3]},
    'color-surface-info-hover': {value: colors.azure[4]},
    'color-surface-info-active': {value: colors.azure[6]},
    'color-fill-warning': {value: colors.orange[9]},
    'color-fill-warning-secondary': {value: colors.orange[7]},
    'color-surface-warning': {value: colors.orange[3]},
    'color-fill-magic': {value: colors.purple[12]},
    'color-fill-magic-secondary': {value: colors.purple[6]},
    'color-fill-magic-secondary-hover': {value: colors.purple[7]},
    'color-fill-magic-secondary-active': {value: colors.purple[8]},
    'color-surface-magic-hover': {value: colors.purple[4]},
    'color-fill-secondary': {value: colors.gray[6]},
    'color-fill-inverse': {value: colors.gray[15]},
    'color-fill-inverse-hover': {value: colors.gray[14]},
    'color-fill-inverse-active': {value: colors.gray[13]},
    'color-surface-transparent': {value: colors.blackAlpha[1]},
    'color-fill-transparent-hover': {value: colors.blackAlpha[5]},
    'color-fill-transparent-active': {value: colors.blackAlpha[6]},
    'color-fill-disabled': {value: colors.blackAlpha[5]},
    'color-fill-transparent-secondary': {value: colors.blackAlpha[6]},
    'color-fill-brand-disabled': {value: colors.blackAlpha[9]},
    'color-backdrop-bg': {value: colors.blackAlpha[14]},
    'color-avatar-fill': {value: colors.gray[11]},
    'color-avatar-one-fill': {value: colors.magenta[7]},
    'color-avatar-two-fill': {value: colors.green[7]},
    'color-avatar-three-fill': {value: colors.cyan[7]},
    'color-avatar-four-fill': {value: colors.azure[7]},
    'color-avatar-five-fill': {value: colors.rose[7]},
    ...
    'color-text-info-on-fill': {value: colors.azure[16]},
    'color-text-inverse-secondary': {value: colors.gray[11]},
    'color-avatar-text-on-fill': {value: colors.gray[1]},
    'color-avatar-one-text-on-fill': {value: colors.magenta[14]},
    'color-avatar-two-text-on-fill': {value: colors.green[14]},
    'color-avatar-three-text-on-fill': {value: colors.cyan[14]},
    'color-avatar-four-text-on-fill': {value: colors.azure[14]},
    'color-avatar-five-text-on-fill': {value: colors.rose[14]},
