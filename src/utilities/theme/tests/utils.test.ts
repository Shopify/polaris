...
describe('buildColors', () => {
    ...
    it('has a default value', () => {
      expect(buildColors({UNSTABLE_colors: {}})).toStrictEqual(
        expect.objectContaining({
          ...
          '--p-critical-surface-subdued-hovered': 'hsl(0, 77%, 93%, 1)',
          '--p-critical-surface-subdued-pressed': 'hsl(0, 77%, 88%, 1)',
    ...
    it('creates variants when given a light surface', () => {
      expect(
        ...
        expect.objectContaining({
          ...
          '--p-critical-surface-subdued-hovered': 'hsl(348, 83%, 93%, 1)',
          '--p-critical-surface-subdued-pressed': 'hsl(348, 83%, 88%, 1)',
    ...
    it('creates variants when given a dark surface', () => {
      expect(
        ...
        expect.objectContaining({
          ...
          '--p-critical-surface-subdued-hovered': 'hsl(348, 83%, 17%, 1)',
          '--p-critical-surface-subdued-pressed': 'hsl(348, 83%, 22%, 1)',
  ...
  describe('opacity', () => {
    it('has a default value', () => {
      expect(buildColors({UNSTABLE_colors: {}})).toStrictEqual(
        expect.objectContaining({
          '--p-opacity': 'hsl(0, 0%, 0%, 0.15)',
          '--p-opacity-deep': 'hsl(0, 0%, 0%, 0.5)',
          '--p-opacity-shallow': 'hsl(180, 5%, 8%, 0.05)',
        }),
      );
    });
  });
