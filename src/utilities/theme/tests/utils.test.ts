...
describe('buildColors', () => {
  ...
  describe('onSurface', () => {
    it('has a default value', () => {
      expect(Object.keys(buildColors({UNSTABLE_colors: {}}))).toStrictEqual(
        expect.arrayContaining([
          '--p-action-disabled-on-dark',
          '--p-action-disabled-on-inverse',
          '--p-action-disabled-on-light',
          '--p-action-disabled-on-surface',
          '--p-action-hovered-on-dark',
          '--p-action-hovered-on-inverse',
          '--p-action-hovered-on-light',
          '--p-action-hovered-on-surface',
          '--p-action-on-dark',
          '--p-action-on-inverse',
          '--p-action-on-light',
          '--p-action-on-surface',
          '--p-action-pressed-on-dark',
          '--p-action-pressed-on-inverse',
          '--p-action-pressed-on-light',
          '--p-action-pressed-on-surface',
