...
describe('buildColors', () => {
  ...
  describe('onSurface', () => {
    it('has a default value', () => {
      expect(Object.keys(buildColors({UNSTABLE_colors: {}}))).toStrictEqual(
        expect.arrayContaining([
          '--p-border-disabled-on-dark',
          '--p-border-disabled-on-inverse',
          '--p-border-disabled-on-light',
          '--p-border-disabled-on-surface',
          '--p-border-on-dark',
          '--p-border-on-inverse',
          '--p-border-on-light',
          '--p-border-on-surface',
          '--p-border-subdued-on-dark',
          '--p-border-subdued-on-inverse',
          '--p-border-subdued-on-light',
          '--p-border-subdued-on-surface',
