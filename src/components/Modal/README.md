...
Note in in an embedded application context all documented properties are not be available. Some properties are only available in stand-alone applications.
