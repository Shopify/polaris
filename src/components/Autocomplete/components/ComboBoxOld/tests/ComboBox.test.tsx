...
const TextField = ComboBoxNew.TextField;
...
describe('<ComboBox/>', () => {
  ...
  describe('options', () => {
    it('passes options to OptionList', () => {
      const comboBox = mountWithComboboxTextFieldContextLegacy(
        <ComboBox
          options={options}
          selected={[]}
    ...
    it.each([
      ...
      const comboBox = mountWithComboboxTextFieldContext(
        <ComboBox
          options={options}
          selected={[]}
          textField={renderTextField()}
...
function mountWithComboboxTextFieldContextLegacy(
  children: any,
  context: any = {},
) {
  return mountWithAppProvider(
    <ComboBoxTextFieldContext.Provider value={context}>
      {children}
    </ComboBoxTextFieldContext.Provider>,
  );
}

function mountWithComboboxTextFieldContext(children: any, context: any = {}) {
  return mountWithApp(
    <ComboBoxTextFieldContext.Provider value={context}>
      {children}
    </ComboBoxTextFieldContext.Provider>,
