...
We want Polaris to be as accessible as possible. A large part of this is making sure that Polaris components can meet Level A and Level AA success criteria of the [Web Content Accessibility Guidelines (WCAG 2.1)](https://www.w3.org/TR/WCAG21/).
...
- Content is marked up appropriately. ([1.3.1 Info and Relationships](https://www.w3.org/TR/WCAG21/#info-and-relationships))
  ...
  - Landmark elements (`<header>`, `<nav>`, etc.) are used if appropriate.
...
- Accessible names, roles, states, and properties are conveyed clearly to assistive technologies. ([4.1.2 Name, Role, Value](https://www.w3.org/TR/WCAG21/#name-role-value))
  ...
  - Complex features have been tested with assistive technologies.
...
- Interface components (like form field borders) and informative icons has a color contrast of 3:1 against backgrounds, including gradients and images. ([1.4.11 Non-text Contrast](https://www.w3.org/TR/WCAG21/#non-text-contrast))
