...
Polaris now supports multiple languages and ships with [many translations](https://github.com/Shopify/polaris/blob/main/locales) to support internationalization. The `i18n` prop is now required to specify the translations you wish to use.
...
If you use [`@shopify/react-i18n`](https://github.com/Shopify/quilt/tree/main/packages/react-i18n) and want to dynamically load translations based on a provided locale, see the [AppProvider README](https://github.com/Shopify/polaris/blob/main/src/components/AppProvider/README.md#using-translations) for more information.
