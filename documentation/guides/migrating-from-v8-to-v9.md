...
This variable is associated with the [`color()`](#color) function.
...
This variable is associated with the [`easing()`](#easing) function.
...
This variable is associated with the [`duration()`](#duration) function.
