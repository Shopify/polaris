...
- [Figma guides](https://www.figma.com/file/tbm3yEIZsOuHS7xJu9zy6Q/text-styles?node-id=5523%3A51)`
  ...
  {
    id: "3krnIoD-HA3IZ_oci2bsJ",
    title: "Actions",
    excerpt: "",
    slug: "actions",
    parentId: "xq3h55fegBY7DJxZYbHL_",
    order: 1,
    layout: "listing",
    blocks: [],
    allowChildren: true,
...

  {
    ...
    parentId: "3krnIoD-HA3IZ_oci2bsJ",
    order: 0,
    layout: "blocks",
    blocks: [
      {
        id: "zHFqcsLWxNfrYnZYKjxqi",
        blockType: "Markdown",
...
- To embed an action or navigation into a line of text, [use the link component](https://polaris.shopify.com/components/link)`
...

  {
    ...
    slug: "caption",
    parentId: "zYBZgw55aHjuigWRhpqbN",
    order: 0,
    layout: "blocks",
    blocks: [
      {
        id: "6GWFenV4jjPXSol1AN7qn",
        blockType: "Markdown",
...
The play button is keyboard accessible and the \`aria-label\` includes a timestamp when the \`videoLength\` prop is set. For example, an 80 second video reads as “Play video of length 1 minute and 20 seconds”. If no \`videoLength\` prop is provided, the default label reads “Play video”.`
...

  {
    ...
    slug: "alpha-card",
    parentId: "BZDxT-loRaDPLWJJUnb8Z",
    order: 0,
    layout: "blocks",
    blocks: [
      {
        id: "PdoKEyBHWrR16JS8MWRYA",
        blockType: "Markdown",
        content: `## Best practices
...
The stack component is for alignment only and doesn’t provide any structural information for assistive technologies. To convey relationships between specific items, consider using the [list component](https://polaris.shopify.com/components/list).`
...

  {
    ...
    slug: "action-list",
    parentId: "_lp8UizjCuP7P8hU2vWGP",
    order: 0,
    layout: "blocks",
    blocks: [
      {
        id: "cUBY-IE8sYrWoP4mq3fKW",
        blockType: "Markdown",
...
Where possible, follow this pattern when writing tabs.`
...

  {
    ...
    slug: "modal",
    parentId: "MJNrMHg-15_npjlm_Hyu2",
    order: 0,
    layout: "blocks",
    blocks: [
      {
        id: "IRA2qzYnmHfNB7xh1PKuq",
        blockType: "Markdown",
...

  {
    ...
    slug: "autocomplete",
    parentId: "g_jb1HtV_Z68yUXtQDveT",
    order: 0,
    layout: "blocks",
    blocks: [
      {
        id: "BhqdI0WNvW0Gf9XUMqwd4",
        blockType: "Markdown",
...
When a merchant uses the button to remove a tag, it is important to make sure that keyboard focus is managed. Moving focus to the next element in the page is recommended.`
...

  {
    ...
    slug: "data-table",
    parentId: "PDNLRR__tYRIy8Ioqvqtt",
    order: 0,
    layout: "blocks",
    blocks: [
      {
        id: "VqvD-N50L1VmovpKOPzoZ",
        blockType: "Markdown",
...

  {
    ...
    slug: "app-provider",
    parentId: "r3OxuRbsdEK8K3n3Dlk8-",
    order: 0,
    layout: "blocks",
    blocks: [
      {
        id: "_O_Zg1eUuOjUnG3Epvx-m",
        blockType: "Markdown",
...
- To put long sections of information under a block that merchants can expand or collapse, [use the collapsible component](https://polaris.shopify.com/components/collapsible)`
...

  {
    ...
    parentId: "XMvBDfX4XGcMO8ndGfC4s",
    order: 0,
    layout: "blocks",
    blocks: [
      {
        id: "lfV6ltibm30R0b7vTNUyv",
        blockType: "Markdown",
...
If you get stuck or want help strategizing a larger contribution, bring it up in [GitHub discussions](https://github.com/Shopify/polaris/discussions/new). The Polaris team and other members of the systems community will help you out. If you see a discussion where you could guide another member of the community, we welcome you to join the conversation.`
  ...
  {
    id: "uCB7oaIac-rqKAXsITFe7",
    title: "Code of Conduct",
    excerpt: "",
    slug: "code-of-conduct",
    parentId: "aek2j4-G8nHuCTGub9dBT",
    order: 0,
    layout: "blocks",
    blocks: [
      {
        id: "zepNY8EP6Aiw8E-YInGm9",
        blockType: "Markdown",
        content: `## Our pledge
...
Design sounds with as much intentionality as other design aspects of Shopify’s products.`
...

  {
    ...
    slug: "accessibility",
    parentId: "o7FgDOJHxAPVL9AEvcS-0",
    order: 0,
    layout: "blocks",
    blocks: [
      {
        id: "k53TP3RGw9Ew5tsDhoRRh",
        blockType: "Image",
        image: {
          lightModeFilename: "",
          darkModeFilename: "",
      ...
      {
        id: "ba21RGCmfvrGIQaxyvf3b",
        blockType: "YoutubeVideo",
        youtubeUrl: ""
      },
      {
        id: "BNWT6nIU7ZYGiFe63mn6k",
        blockType: "Markdown",
    ...
    thumbnailImage: {
      ...
      width: 500,
      height: 0,
      lightModeFilename: "my-amazing-file.jpg",
      darkModeFilename: ""
    }
  },

  {
    id: "AiOiKywNAxl7-yRAOXRIv",
...
- Evolve experiences seamlessly. They should keep getting better with time and information.`
    ...
    hasSeparatorInNav: false,
    thumbnailImage: {
      alt: "A great image showing something",
      width: 400,
      height: 355,
      lightModeFilename: "edit-do@2x.png",
      darkModeFilename: "test-dark.jpg"
    }
  },

  {
    id: "fUONg3uhhIKpNfj7mTxBd",
...
- Consider how your IA will adapt to multiple environments and their existing patterns (for instance, iOS, Android, desktop browsers, chat bots, retail products like Point of Sale).`
...

  {
    ...
    parentId: "3lgQvy4e_cVWI8OUhkmGR",
    order: 1,
    layout: "blocks",
    blocks: [
      {
        id: "y5fWKEAEGO_FyfiDn2QaM",
        blockType: "Markdown",
...
By building with Polaris and [App Bridge](https://shopify.dev/apps/tools/app-bridge) and following the [App Design Guidelines](https://shopify.dev/apps/design-guidelines), you'll create a streamlined experience with the rest of the Shopify admin.`
  ...
  {
    id: "J7oUdhHpKq7dIvfoMgo-f",
    title: "Icons in Figma",
    excerpt: "",
    slug: "icons-in-figma",
    parentId: "AJTSNhpTVpNvGc53JiO7k",
    order: 0,
    layout: "blocks",
    blocks: [],
    allowChildren: false,
  ...
  {
    id: "LeUn4iOLjAIWXpQQD0jFG",
    title: "Colors",
    excerpt: "",
    slug: "colors",
    parentId: "LlX3QnUtXy8IzpINRYi0V",
    order: 0,
    layout: "blocks",
    blocks: [],
    allowChildren: false,
