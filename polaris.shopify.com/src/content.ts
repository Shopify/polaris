...
const pages: Content['pages'] = [
  ...
  {
    id: "B221Kk9Dn7ZORf7P9ctX7",
    title: "Actions",
    excerpt: "",
    slug: "actions",
    parentId: "P41ui54lvnCnWGZ6Cx7Yu",
    order: 1,
    useCustomLayout: true,
    blockIds: [],
    allowChildren: true,
  ...
  },
  {
    ...
    parentId: "B221Kk9Dn7ZORf7P9ctX7",
    order: 0,
    useCustomLayout: false,
    blockIds: [
      "t0zMyBi11Ja3OeEWqwyVY"
    ],
    allowChildren: false,
    hideInNav: false,
    noIndex: false,
  ...
  },
  {
    ...
    slug: "caption",
    parentId: "rY6tqh55BZWxBBe2-Pj5W",
    order: 0,
    useCustomLayout: false,
    blockIds: [
      "4tp2jJUNrdkdueXCIULDF"
    ],
    allowChildren: false,
    hideInNav: false,
    noIndex: false,
  ...
  },
  {
    ...
    pageMeta: {
      ...
      lifeCyclePhase: "Deprecated",
      lifeCycleNotice: "Card was built prior to layout primitives like box, inline, and alpha stack. The new layout primitives can be used in combination to achieve similar results to card, or the existing legacy card."
    },
    hasSeparatorInNav: false,
    thumbnailImageId: null
  },
  {
    id: "wPfITd4UjCDOo4Dr6dhwc",
    title: "Display text",
  ...
  },
  {
    ...
    pageMeta: {
      ...
      lifeCyclePhase: "Deprecated",
      lifeCycleNotice: "Grid was built prior to layout primitives like columns, inline, and alpha stack. Comparatively, grid is difficult to learn, document, and understand its usage in a codebase. The new layout primitives should be used in combination to achieve similar results to grid."
    },
    hasSeparatorInNav: false,
    thumbnailImageId: null
  },
  {
    id: "6ufHrSIOQJY2yMBGf97P_",
    title: "Heading",
  ...
  },
  {
    ...
    pageMeta: {
      ...
      lifeCyclePhase: "Deprecated",
      lifeCycleNotice: "The sheet component encourages designers to create a new layer on top of the page instead of improving the existing user interface. It also blocks other parts of the UI, forces users to switch context, and adds complexity to otherwise simple interactions."
    },
    hasSeparatorInNav: false,
    thumbnailImageId: null
  },
  {
    id: "1r7Ei_3083WFxse0rFhET",
    title: "Stack",
    ...
    pageMeta: {
      ...
      lifeCyclePhase: "Deprecated",
      lifeCycleNotice: "Stack was built prior to layout primitives like box, inline, and alpha stack. The new layout primitives can be used in combination to achieve similar results to stack, or the existing legacy stack."
    },
    hasSeparatorInNav: false,
    thumbnailImageId: null
  },
  {
    id: "4O7quN6YbgvEqGnsL8e6h",
    title: "Subheading",
  ...
  },
  {
    ...
    pageMeta: {
      ...
      lifeCyclePhase: "Deprecated",
      lifeCycleNotice: "The TextContainer is a simple layout component which was made redundant by the AlphaStack component. Use AlphaStack with `gap` values of 2, 4, and 5 to replicate layouts."
    },
    hasSeparatorInNav: false,
    thumbnailImageId: null
  },
  {
    id: "YlvEfF-TSdJWA_3GhXjgs",
    title: "Text style",
  ...
  },
  {
    ...
    slug: "alpha-card",
    parentId: "uMe6DziT6uQhqpj-iyVs0",
    order: 0,
    useCustomLayout: false,
    blockIds: [
      "MywLTKCyic7eq-tmKtbIM"
    ],
    allowChildren: false,
    hideInNav: false,
    noIndex: false,
    ...
    pageMeta: {
      ...
      examples: [
        ...
        },
        {
          ...
          description: "Cards have an 8px border radius by default. Rounding may also be applied responsively with the roundedAbove prop. This enables cards to be softened on larger screens, but squared off when they are full bleed on smaller devices."
        }
      ],
      lifeCyclePhase: "Alpha",
      lifeCycleNotice: "This component is a work in progress and ready for exploratory usage, with breaking changes expected in minor version updates. Please use with caution. Learn more about our [Component lifecycle](/getting-started/components-lifecycle)."
    },
    hasSeparatorInNav: false,
    thumbnailImageId: null
  },
  {
    id: "gryID_v_XUrgSzoNKkKSZ",
    title: "Alpha stack",
      ...
      examples: [
        {
          ...
          title: "Default",
          description: "By default, stack is left aligned and stacked items are spaced with 16px in between."
        },
        {
          fileName: "alpha-stack-with-gap.tsx",
          title: "Gap",
          description: "Gaps between stack children can be adjusted using the Space token."
        },
        {
          fileName: "alpha-stack-with-full-width-children.tsx",
          title: "Full width",
          description: "Use a boolean to make Stack full width."
        },
        {
          fileName: "alpha-stack-with-align.tsx",
          title: "Alignment",
          description: "Use to horizontally align Stack."
        }
      ],
      lifeCyclePhase: "Alpha",
      lifeCycleNotice: "This component is a work in progress and ready for exploratory usage, with breaking changes expected in minor version updates. Please use with caution. Learn more about our [Component lifecycle](/getting-started/components-lifecycle)."
      ...
      examples: [
        {
          ...
          title: "Vertical",
          description: "Content will bleed vertically into the surrounding layout using the vertical prop."
        },
        {
          fileName: "bleed-horizontal.tsx",
          title: "Horizontal",
          description: "Content will bleed horizontally into the surrounding layout using the horizontal prop."
        },
        {
          fileName: "bleed-specific-direction.tsx",
          title: "Specific direction",
          description: "Content will bleed into the surrounding layout in a specific direction using the top, bottom, left, or right prop."
        },
        {
          fileName: "bleed-all-directions.tsx",
          title: "All directions",
          description: "Content will bleed into the surrounding layout in all directions using the spacing prop."
        }
      ],
      lifeCyclePhase: "Alpha",
      lifeCycleNotice: "This component is a work in progress and ready for exploratory usage, with breaking changes expected in minor version updates. Please use with caution. Learn more about our [Component lifecycle](/getting-started/components-lifecycle)."
      ...
      examples: [
        {
          ...
          title: "Default",
          description: "By default, box has no padding, borders, border radius, background, or shadows."
        },
        {
          fileName: "box-with-color.tsx",
          title: "Color",
          description: "Background color of box and text color inside a box can be adjusted using the [Color tokens](https://polaris.shopify.com/tokens/colors)."
        },
        {
          fileName: "box-with-border.tsx",
          title: "Border",
          description: "Border width can be adjusted using the [Shape tokens](https://polaris.shopify.com/tokens/shape), and a subset of tokens allows different types of border."
        },
        {
          fileName: "box-with-border-radius.tsx",
          title: "Border radius",
          description: "Border radius can be adjusted using the [Shape tokens](https://polaris.shopify.com/tokens/shape)."
        },
        {
          fileName: "box-with-padding.tsx",
          title: "Padding",
          description: "Padding can be added to either all sides, left, right, top, and bottom, using the [Spacing tokens](https://polaris.shopify.com/tokens/spacing)."
        },
        {
          fileName: "box-with-shadow.tsx",
          title: "Shadow",
          description: "Shadow can be applied using the Shadow token. The base is [--p-shadow-base](https://polaris.shopify.com/tokens/depth)."
        }
      ],
      lifeCyclePhase: "Alpha",
      lifeCycleNotice: "This component is a work in progress and ready for exploratory usage, with breaking changes expected in minor version updates. Please use with caution. Learn more about our [Component lifecycle](/getting-started/components-lifecycle)."
      ...
      examples: [
        {
          ...
          title: "Default",
          description: "By default, there are 6 columns with 16px spacing between them."
        },
        {
        ...
        },
        {
          ...
          title: "Column width",
          description: "Individual column width can be adjusted."
        },
        {
          fileName: "columns-with-set-number.tsx",
          title: "Number of columns",
          description: "Use the columns prop to set the number and width of columns across breakpoints."
        }
      ],
      lifeCyclePhase: "Alpha",
      lifeCycleNotice: "This component is a work in progress and ready for exploratory usage, with breaking changes expected in minor version updates. Please use with caution. Learn more about our Component lifecycle](/getting-started/components-lifecycle)."
      ...
      examples: [
        {
          ...
          title: "Default",
          description: "Items are vertically centered with 16px of space around them. They’ll wrap onto multiple lines when needed."
        },
        {
          fileName: "inline-with-non-wrapping.tsx",
          title: "Non-wrapping",
          description: "Use to create Inline where the children will not wrap to new rows on small screens."
        },
        {
          fileName: "inline-with-gap.tsx",
          title: "Gap",
          description: "Use to control gaps around items in inline in standard increments."
        },
        {
          fileName: "inline-with-vertical-alignment.tsx",
          title: "Vertical alignment",
          description: "Use to vertically align Inline."
        },
        {
          fileName: "inline-with-horizontal-alignment.tsx",
          title: "Horizontal alignment",
          description: "Use to horizontally align Inline."
        }
      ],
      lifeCyclePhase: "Alpha",
      lifeCycleNotice: "This component is a work in progress and ready for exploratory usage, with breaking changes expected in minor version updates. Please use with caution. Learn more about our [Component lifecycle](/getting-started/components-lifecycle)."
  ...
  },
  {
    ...
    slug: "action-list",
    parentId: "S35FrRD9IeLeoH1jkcv9t",
    order: 0,
    useCustomLayout: false,
    blockIds: [
      "7XcL5bUuVYbep8UCZAshl"
    ],
    allowChildren: false,
    hideInNav: false,
    noIndex: false,
  ...
  },
  {
    ...
    slug: "modal",
    parentId: "QwRXHrhq23nJTGX1TeRGl",
    order: 0,
    useCustomLayout: false,
    blockIds: [
      "qIcsIAZaSh0h9HLH7YQRO"
    ],
    allowChildren: false,
    hideInNav: false,
    noIndex: false,
  ...
  },
  {
    ...
    slug: "autocomplete",
    parentId: "FUYdubYt8xbTnbuWgTt4d",
    order: 0,
    useCustomLayout: false,
    blockIds: [
      "uk0S0DB_34pm5frzWYXcd"
    ],
    allowChildren: false,
    hideInNav: false,
    noIndex: false,
  ...
  },
  {
    ...
    slug: "data-table",
    parentId: "HIKtLEq9To_x2dIozcQEw",
    order: 0,
    useCustomLayout: false,
    blockIds: [
      "GbtJ7tWL1l3YvO28EcyU8"
    ],
    allowChildren: false,
    hideInNav: false,
    noIndex: false,
  ...
  },
  {
    ...
    pageMeta: {
      ...
      lifeCyclePhase: "Beta",
      lifeCycleNotice: "This component is ready for wider adoption, usage is encouraged for most cases. Breaking changes are possible in minor version updates. To learn more please read about our [Component lifecycle](/getting-started/components-lifecycle)"
    },
    hasSeparatorInNav: false,
    thumbnailImageId: null
  },
  {
    id: "_7sTPeg3ATmcGK9wp36Xu",
    title: "Utilities",
    excerpt: "",
    slug: "utilities",
    parentId: "P41ui54lvnCnWGZ6Cx7Yu",
  ...
  },
  {
    ...
    slug: "app-provider",
    parentId: "_7sTPeg3ATmcGK9wp36Xu",
    order: 0,
    useCustomLayout: false,
    blockIds: [
      "w_0aKFoYYMl0FEA_51Evi"
    ],
    allowChildren: false,
    hideInNav: false,
    noIndex: false,
  ...
  },
  {
    ...
    parentId: "pnQxmMEa0QXxEBA7jelGM",
    order: 0,
    useCustomLayout: false,
    blockIds: [
      "Y-zx0LGeF4zxFziWngRiB"
    ],
    allowChildren: false,
    hideInNav: false,
    noIndex: false,
  ...
  },
  {
    ...
    useCustomLayout: false,
    blockIds: [
      "AYZg-Y9dhXU317BLM9lon",
      "DpyydBUbbD2-dFGdWFUq2"
    ],
    allowChildren: false,
    hideInNav: false,
    noIndex: false,
  ...
  {
    id: "CWsH9WCyFeERN5Tw9CH6M",
    title: "Code of Conduct",
    excerpt: "",
    slug: "code-of-conduct",
    parentId: "h4jSCcaW3vNMXicsR5TOB",
    order: 0,
    useCustomLayout: false,
    blockIds: [
      "wqzuoBp4NYmuqhskjXFPA"
    ],
    allowChildren: false,
    hideInNav: false,
    noIndex: false,
  ...
  },
  {
    ...
    slug: "accessibility",
    parentId: "4t9deK_glkQDHg7CkllET",
    order: 0,
    useCustomLayout: false,
    blockIds: [
      "khBLVRy0gcogVwymjHSVH"
    ],
    allowChildren: false,
    hideInNav: false,
    noIndex: false,
  ...
  },
  {
    ...
    parentId: "INXsyvHDJT0V70qmJZsMl",
    order: 1,
    useCustomLayout: false,
    blockIds: [
      "Sx79wVkeFaSJKkb8z_IZ-"
    ],
    allowChildren: false,
    hideInNav: false,
    noIndex: false,
  ...
  {
    id: "2ENG8FljxtqZsSlZG30gn",
    title: "Colors",
    excerpt: "",
    slug: "colors",
    parentId: "YVZ7xAY58wu0Fu5FTdk6k",
    order: 0,
    useCustomLayout: true,
    blockIds: [],
    allowChildren: false,
