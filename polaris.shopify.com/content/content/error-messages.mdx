...
As always, follow all our content principles of keeping it short, using plain language, and getting rid of repetition. Good design can reduce the need for error messages by preventing them in the first place.
...
The bank account we have on file was closed. Update your details, and we’ll retry automatically.
...
Your payout was not deposited because your bank account was closed. Go to your bank account details and update them to match a valid checking account. Then save so that we can retry.
