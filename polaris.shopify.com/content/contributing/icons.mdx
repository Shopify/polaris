...
6. Open a terminal inside VS Code and run `yarn install && yarn optimize` in `polaris-icons` to optimize icons. Your build will fail if you skip this step.
7. Run `yarn changeset` to add an entry to the change log and release notes.
