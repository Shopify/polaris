...
![Good example of flexible layouts with text expansion](/images/internationalization-page/info-hierarchy-do@2x.png)

Lay out your elements in a way where text expansion doesn’t hinder your information hierarchy.

#### Don’t

![Bad example of flexible layouts with text expansion](/images/internationalization-page/info-hierarchy-dont@2x.png)
...
![Good example of narrow columns with text expansion](/images/internationalization-page/narrow-columns-do@2x.png)

Use single columns to stack elements flexibly to accomodate for text expansion.

#### Don’t

![Bad example of narrow columns with text expansion](/images/internationalization-page/narrow-columns-dont@2x.png)
...
![Good example of avoiding sentence-based UI](/images/internationalization-page/sentence-based-ui-do@2x.png)
...
![Bad example of sentence-based UI](/images/internationalization-page/sentence-based-ui-dont@2x.png)
...
![Good example of hyperlinking text](/images/internationalization-page/hyperlink-text-do@2x.png)
...
![Bad example of link within sentence](/images/internationalization-page/hyperlink-text-dont@2x.png)
...
![Good example of icon usage](/images/internationalization-page/icons-meaning@2x.png)
...
![Bad example of text fields](/images/internationalization-page/colors-cultural-context@2x.png)
