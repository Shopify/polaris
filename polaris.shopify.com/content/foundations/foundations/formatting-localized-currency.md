...
![Short format in today’s sales card](/images/internationalization-page/do-use-short-format@2x.png)

#### Don’t

Use [explicit format](#explicit-format) except when presenting store currency within in a mixed-currency context.

![Incorrect explicit format in today’s sales card](/images/internationalization-page/dont-use-explicit-format@2x.png)
...
![](/images/internationalization-page/paid-status-explicit@2x.png)
...
![](/images/internationalization-page/refund-non-store-currency@2x.png)
...
![](/images/internationalization-page/short-format-non-total@2x.png)
...
![](/images/internationalization-page/short-format-installment-prices@2x.png)
...
![](/images/internationalization-page/short-format-unit-prices@2x.png)
...
![](/images/internationalization-page/short-format-itemized-prices@2x.png)
