...
![Text field validation](/images/errors-page/text-field-validation-error@2x.png)
...
![Settings warning error](/images/errors-page/settings-warning@2x.png)
...
![Yellow page level banner](/images/errors-page/page-level-warning-banner@2x.png)

</div>
<div class="Image Image--border">

![Red page level banner](/images/errors-page/page-level-critical-banner@2x.png)
...
![Yellow section level banner](/images/errors-page/section-level-warning@2x.png)
![Yellow field level banner](/images/errors-page/field-level-warning-02@2x.png)
...
![Warning exception list error](/images/errors-page/exception-list-warning@2x.png)

</div>
<div class="Image Image--border">

![Critical exception list error](/images/errors-page/high-risk-fraud@2x.png)
...
![Yellow home notification](/images/errors-page/home-notification-warning@2x.png)

</div>
<div class="Image Image--border">

![Red home notification](/images/errors-page/home-notification-critical@2x.png)
...
![Admin page not found error](/images/errors-page/page-not-found@2x.png)

</div>
<div class="Image Image--border">

![Admin page load error](/images/errors-page/admin-error@2x.png)
...
![Red banner with high fraud risk message](/images/errors-page/red-banner@2x.png)

#### Don’t

![Yellow banner with high fraud risk message](/images/errors-page/yellow-banner@2x.png)
...
![Form validation with red banner](/images/errors-page/validation-banner-red@2x.png)

#### Don’t

![Form validation with yellow banner](/images/errors-page/validation-banner-yellow@2x.png)
...
![Yellow banner with warning message](/images/errors-page/yellow-do@2x.png)

#### Don’t

![Red banner with warning message](/images/errors-page/yellow-dont@2x.png)
...
![Toast error message](/images/errors-page/dont-toast-error@2x.png)
...
![Modal error message](/images/errors-page/dont-modals-for-errors@2x.png)
...
![Home notification error message](/images/errors-page/dont-home-notification@2x.png)
...
![Text field validation error](/images/errors-page/text-field-validation-error-no-cursor@2x.png)
...
![Initial validation check with purple border](/images/errors-page/text-field-validation-purple-incorrect-input@2x.png)
...
![Text field turns red](/images/errors-page/text-field-validation-error-no-cursor@2x.png)
...
![Text field validation with cursor by incorrect semi colon](/images/errors-page/text-field-validation-cursor@2x.png)
...
![Text field validation with purple border](/images/errors-page/text-field-validation-purple-border-cursor@2x.png)
...
![Text field validation in loading state with spinner](/images/errors-page/text-field-validation-loading@2x.png)
...
![Red form validation banner](/images/errors-page/validation-banner-red@2x.png)
...
![Instructional validation banner](/images/errors-page/validation-banner-content-do@2x.png)

#### Don’t

![Validation banner that only points out that there is an error](/images/errors-page/validation-banner-content-dont@2x.png)
...
![Spinner displaying on save](/images/errors-page/submission-progress@2x.png)
...
![Validation error for a price entry field](/images/errors-page/input-validation@2x.png)
...
![In line warning banner below a drop down](/images/errors-page/settings-warning@2x.png)
...
![Error message with arrows pointing at different parts of the message](/images/errors-page/banner-breakdown@2x.png)
...
![Page level warning banner](/images/errors-page/page-level-warning-banner@2x.png)
...
![Warning banner at the top of a card below the card title](/images/errors-page/section-level-warning@2x.png)
![Small warning banner in a section within a card](/images/errors-page/section-level-warning@2x.png)
...
![Exception list warning](/images/errors-page/exception-list-warning@2x.png)

</div>
<div class="Image Image--border">

![Exception list error](/images/errors-page/high-risk-fraud@2x.png)
...
![Structure of home notification with a header, body content, and button](/images/errors-page/home-notification-anatomy@2x.png)
...
![Warning home notification with credit card expiry message](/images/errors-page/home-notification-warning@2x.png)

#### Don’t

![Warning home notification with chargeback message](/images/errors-page/dont-home-notification@2x.png)
...
![Critical home notification with account on hold message](/images/errors-page/home-notification-critical@2x.png)

#### Don’t

![Critical home notification with out of stock message](/images/errors-page/dont-home-notification-02@2x.png)
...
![Page not found error with internet connection message](/images/errors-page/page-not-found-02@2x.png)

#### Don’t

![Page not found error with oops, something went wrong message](/images/errors-page/dont-page-not-found@2x.png)
...
![Problem loading page error with troubleshooting tips](/images/errors-page/admin-error@2x.png)

#### Don’t

![Problem loading page error with content that talks about operational engineers](/images/errors-page/dont-admin-error@2x.png)
...
![Page not found error](/images/errors-page/page-not-found@2x.png)
...
![Carrier may not be able to pick up package error message](/images/errors-page/warning-no-solution@2x.png)
![Carrier may not be able to pick up package error message](/images/errors-page/warning-no-solution-2@2x.png)
