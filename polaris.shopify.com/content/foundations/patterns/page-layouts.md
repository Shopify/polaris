...
![Screen from the Shopify admin, highlighting the top bar with logo, search and profile menu, and the navigation sidebar on the left](/images/layout-page/app-frame-diagram@2x.png)
...
![Screen highlighting the top of the page content and the side margins of the page](/images/layout-page/page-frame-diagram@2x.png)
...
![Admin screen highlighting a typical layout](/images/layout-page/page-layout-diagram@2x.png)
...
![Screen highlighting a layout with: page-level banner up top, primary and secondary sections in the middle, and footer actions below](/images/layout-page/cards-in-layout-diagram@2x.png)
...
![Diagram showing the anatomy of a card component, showing the card title and header actions at the top, two sections in the middle, and footer below](/images/layout-page/card-layout-diagram@2x.png)
...
![Typical embedded app settings screen, showing the embedded page header with app icon and breadcrumb.](/images/layout-page/embedded-page-diagram@2x.png)
...
![Shopify Capital sell screen. The standard app frame and page components contain a layout with a large illustration and introductory heading. This is followed by side-by-side cards with different offers, and a grid of selling points.](/images/layout-page/sell-screen@2x.png)
...
![Shopify theme editor screen, with specialized top bar and side bar offering edit controls, and a preview of the online store website in the middle](/images/layout-page/theme-editor-screen@2x.png)
...
![Generic customers list screen, showing how a wider layout can fit more content about each customer](/images/layout-page/page-frame-wide@2x.png)
...
![Example screen showing a complex form in a narrow layout](/images/layout-page/page-frame-narrow@2x.png)
...
![Product details page, with cards for product title, description and images in the left, primary column, and cards for publishing to sales channels and product tags in the secondary column](/images/layout-page/page-layout-details@2x.png)
...
![Create shipping labels screen, with configuration for the labels in the left, primary column, and summary with “Buy shipping labels” button in the secondary column](/images/layout-page/page-layout-task-with-summary@2x.png)
...
![General settings page, with annotated sections for “Store details” and “Store address” visible](/images/layout-page/page-layout-annotated@2x.png)
...
![A text label, text value and badge arranged in a row with space between](/images/layout-page/stack-horizontal@2x.png)
...
![A custom heading on the left (labeled “fill”) and UI control pushed to the right (labeled “auto”)](/images/layout-page/stack-with-fill@2x.png)
