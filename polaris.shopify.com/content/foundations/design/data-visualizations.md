...
![A light grey chart with axis lines](/images/data-viz/do/ensure-axis-lines-only-appear-where-data-appears@2x.png)

#### Don’t

Use bleeding axis lines to the edge of the screen.
![A chart with axis lines filling the screen](/images/data-viz/dont/use-bleeding-axis-lines-to-the-edge-of-the-screen@2x.png)
...
![A bar chart plotting time using 12am, 8am, 12pm, and 8pm](/images/data-viz/do/skip-labels-in-regular-intervals@2x.png)

#### Don’t

Try to squeeze all labels together.
![A chart plotting time with too many axis labels](/images/data-viz/dont/squeeze-all-labels-together@2x.png)
...
![A chart showing the days of the week abbreviated to Mon, Tues, and so on](/images/data-viz/do/use-standard-abbreviations-for-labeling2@2x.png)

#### Don’t

Slant labels to make them fit.
![A chart with labels slanted at a 45 degree angle](/images/data-viz/dont/slant-labels-to-make-them-fit2@2x.png)
...
![A chart with a y-axis representing a thousand dollars as “$1.0k”](/images/data-viz/do/abbreviate-using-k-for-thousand-b-for-billion-and-include-the-unit@2x.png)

#### Don’t

Go over 3 numeric characters, 1 decimal, or 1 letter.
![A chart with a y-axis that represents the value of a thousand and one dollars as “$1.001k”](/images/data-viz/dont/go-over-3-numeric-characters-1-decimal-and-1-single-letter@2x.png)
...
![A bar chart with the abbreviated days of the week centered on the ticks which are centered on the bars that they represent](/images/data-viz/do/center-all-labels-with-the-bar-and-tick2@2x.png)

#### Don’t

Use decimals on the x-axis labels.
![A bar chart plotting numbers with decimals on the x-axis](/images/data-viz/dont/use-decimals-on-x-axis-labels2@2x.png)
...
![A chart with a dollar value on the y-axis that’s aligned to the left and raised slightly from the grey axis](/images/data-viz/do/left-align-labels-and-keep-them-slightly-above-the-y-axis-lines@2x.png)
...
![A line graph with y-axis and x-axis labels and a single purple line plotting data](/images/data-viz/single-data-series@2x.png)

<!-- end -->

<!-- floatedcontent -->

![A line chart with 2 different colors comparing current values to a past value](/images/data-viz/single-comparison-to-past@2x.png)
...
![A line chart with multiple data points represented by different colors](/images/data-viz/multiseries-data@2x.png)

<!-- end -->

<!-- floatedcontent -->

![One example of an upward trend in percentage sales represented in gren and another example of a downward trend in](/images/data-viz/biased-charts@2x.png)
...
bar.
![A horizontal bar chart with 2 dollar values within the bar and the lowest value outside of the bar to the right](/images/data-viz/do/include-a-label-on-each-bar-if-the-bar-is-too-small-include-it-outside-of-the-bar@2x.png)

#### Do

Include a label on top of each bar to display what data it’s showing.
![A horizontal bar chart displaying the country represented by each bar](/images/data-viz/do/include-a-label-on-top-of-each-bar-to-display-what-data-it-is-showing@2x.png)
...
![A horizontal bar chart with solid purple positive bars and purple negative bars set to 60% opacity](/images/data-viz/do/give-negative-bars-60-opacity@2x.png)

#### Don’t

Use multiple colors for the bars.
![A horizontal bar chart using a different color for each bar](/images/data-viz/dont/use-multiple-colors-for-the-bars@2x.png)
...
Use one color for all bars.
![A bar chart showing a data trend with the same bar color](/images/data-viz/do/use-one-color-for-all-bars@2x.png)

#### Don’t

Use multiple colors for the bars.
![A bar chart showing the same data point with different colors](/images/data-viz/dont/use-multiple-colors-for-the-bars2@2x.png)
...
Make the width of each bar about twice as wide as the space between them.
![A bar chart properly formatted with spaces half the size of each bar](/images/data-viz/do/make-the-width-of-each-bar-about-twice-the-space-between-them@2x.png)

#### Don’t

Make the bars too skinny.
![A bar chart with spaces 4 times larger than the bar itself](/images/data-viz/dont/make-the-bars-too-skinny@2x.png)
...
![A bar chart with a tool tip on a bar displaying the date axis point and the dollar value axis point](/images/data-viz/do/include-tooltips-with-both-the-x-axis-value-and-y-axis-value@2x.png)
...
![A line chart with 2 lines using purple and teal to represent the years 2015 and 2016](/images/data-viz/do/use-contrasting-colors-and-include-a-legend@2x.png)
...
![A line chart with 4 lines of different colors](/images/data-viz/dont/use-more-than-4-lines-try-to-stick-to-2-lines@2x.png)
...
![Diagram showing “sales this week” with a numeric dollar value](/images/data-viz/do/include-a-dimension-of-time-to-scope-the-value@2x.png)
...
![Diagram of green being used to signify an upward trend in data](/images/data-viz/do/use-green-to-signify-positive-movement@2x.png)

Use red for negative movement.
![Diagram of red being used to signify a downward trend in data](/images/data-viz/do/use-red-to-signify-negative-movement@2x.png)
...
![A table showing product inventory with product names aligned to the left and numbers aligned to the right](/images/data-viz/do/left-align-non-numeric-values-and-right-align-numeric-values@2x.png)

#### Don’t

Center column headers.
![A table showing product inventory data with headers, numbers, and titles centered](/images/data-viz/dont/center-align-columns@2x.png)
...
![A table with three rows separated by light grey lines](/images/data-viz/do/separate-rows-with-dividing-lines@2x.png)

#### Don’t

Highlight every other row to indicate separation.
![A table with a white background and grey lines using a darker grey every other row](/images/data-viz/dont/separate-rows-by-highlighting-every-other-row@2x.png)
...
![A diagram showing individual product sales underneath the total sales in bold type](/images/data-viz/do/place-bold-totals-in-the-first-row@2x.png)
