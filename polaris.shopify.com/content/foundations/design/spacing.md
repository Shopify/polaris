...
![The mobile interface of the Shopify admin on a 4 pixel grid.](/images/design/spacing/spacing-4px-grid@2x.png)
...
![A profile card component on a 4 pixel grid with text placed vertically at 20 pixel intervals](/images/design/spacing/spacing-20px-elements@2x.png)
...
![Several paragraphs of text with space in between, with their edges and spacing highlighted](/images/design/spacing/spacing-text-container@2x.png)
...
![A text label, text value and badge arranged in a row, with their edges and spacing highlighted](/images/design/spacing/spacing-stack@2x.png)
...
![Two text fields showing spacing within and between them](/images/design/spacing/spacing-less-space@2x.png)
...
![Detail of a screen from Shopify admin, showing space between the page header and cards, between the cards, and the space around the layout](/images/design/spacing/spacing-more-space@2x.png)
...
![Space between icon and text in buttons and list items](/images/design/spacing/spacing-extra-tight@2x.png)
...
![Two buttons in a row, with annotation showing the space between](/images/design/spacing/spacing-tight@2x.png)
...
![A form showing horizontal and vertical space between text fields](/images/design/spacing/spacing-base-forms@2x.png)
...
![Detail of a card component from a large screen display, showing padding on the top, sides and between card sections](/images/design/spacing/spacing-loose-forms@2x.png)
...
![Detail of a card on a small screen, showing reduced side padding](/images/design/spacing/spacing-loose-mobile@2x.png)
...
![Detail of a screen from the Shopify admin, showing horizontal and vertical spacing between cards](/images/design/spacing/spacing-loose-between-cards@2x.png)
...
![Closeup of a badge component, showing how its internal padding can be arbitrary, but its height is a multiple of 4px and the text within is vertically centered](/images/design/spacing/spacing-exception-badge@2x.png)
...
![Three buttons in a row, showing how their width depends on their text content](/images/design/spacing/spacing-text-width@2x.png)
...
![Diagram of a button with optical adjustment for an icon](/images/design/spacing/spacing-optical-adjustment@2x.png)
