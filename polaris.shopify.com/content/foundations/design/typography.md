...
![Diagram presenting text that is left aligned](/images/design/type/type-left-align@2x.png)
...
![Diagram presenting text that is emphasised by being bold](/images/design/type/type-strong@2x.png)
...
![Diagram presenting text that is underlined](/images/design/type/type-underline@2x.png)
...
![Diagram presenting text that is subdued in a lighter gray color](/images/design/type/type-subdued@2x.png)
...
![An interface showing the title of a page before its contents](/images/design/type/type-pageheading@2x.png)
...
![An empty state and a modal with large display headings](/images/design/type/type-display@2x.png)
...
![Two interface cards with headings](/images/design/type/type-heading@2x.png)
...
![An interface card titled with a large heading text size followed by a smaller subheading](/images/design/type/type-subheading@2x.png)
...
![A line chart with small, caption-sized labels](/images/design/type/type-caption@2x.png)
...
![A diagram showing a selection of default iOS, Mac, Windows, Android and Linux fonts](/images/design/type/type-fontstack@2x.png)
