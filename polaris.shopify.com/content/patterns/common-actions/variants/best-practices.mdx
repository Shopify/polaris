...
<LayoutSection card>
  ...
  <Text>
    ...
    Actions on desktop and mobile should consider both cursor and touch interactions, but the primary interaction for the desktop is cursor-based. Take advantage of added real-estate and interactions by using progressive disclosure to expose actions in context when the merchants needs them.
