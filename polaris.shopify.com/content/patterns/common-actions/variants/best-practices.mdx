...
<LayoutSection card>
  ...
  <Text>
    ...
    Take advantage of added real-estate and interactions by using progressive disclosure to expose actions in context when the merchants needs them.
  ...
  <Small variant="do">
    ...
    ![An image showing a text button using the emphasis color as the only indicator of interactivity.](/images/patterns/common-actions/common-actions-best-practices-desktop-tooltip@2x.png)
  ...
  <Small variant="do">
    ...
    ![An image showing a text button using the emphasis color as the only indicator of interactivity.](/images/patterns/common-actions/common-actions-best-practices-desktop-tooltip-delay@2x.png)
  ...
  <Large variant="do">
    ...
    ![An image showing a text button using the emphasis color as the only indicator of interactivity.](/images/patterns/common-actions/common-actions-best-practices-desktop-hover@2x.png)
  ...
  <Text>
    ...
    Optimize for touch enabled devices by considering placement, target size, and interactions native to iOS and Android.
  ...
  <Large variant="do">
    ...
    ![An image showing a text button using the emphasis color as the only indicator of interactivity.](/images/patterns/common-actions/common-actions-best-practices-mobile@2x.png)
