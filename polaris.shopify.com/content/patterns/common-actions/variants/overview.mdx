...
![A collection of examples of add actions in the page header, in a list, and
  ...
  <Text>
    ...
    Add actions should always be visible. They are often placed in the list header to the right of the title when “add” is the main action of the list.
  ...
  <Large>
    ...
    ![A few cards each with several list items in a viewable state with a main add action in the list header.](/images/patterns/common-actions/types/common-action-types-add-list-top@2x.png)

  </Large>

  <Text>

    Place add actions at the bottom of a list when there are a limited number of items or when “add” is secondary to other surrounding actions. For example, editing an item within the list.
  ...
  <Text>
    ...
    Add actions are placed at the bottom of a list of selectable options. These actions are secondary to the main action of selecting.
  ...
  <Text>
    ...
    Place add actions associated with a table in the table, card or page header to keep them discoverable.
  ...
  <Large>
    ...
    ![A table of products with the add action in the card header above the table.](/images/patterns/common-actions/types/common-action-types-add-table-top@2x.png)
...
<LayoutSection card>
  ...
  <Medium variant="do">
    ...
    Provide feedback inline using a confirmation check icon post-click or tap. See the [copy to clipboard](https://storybook.polaris.shopify.com/?path=/story/all-components-button--copy-to-clipboard) example.
    ...
    <video width="100%" height="auto" controls playsInline muted loop>
      <source
        ...
        type="video/mp4"
      />
      Use a confirmation “copied to clipboard” toast message when “copy” is within a list of actions.
    </video>

    Use a confirmation “copied to clipboard” toast message when the action is within a list of actions.
...
<LayoutSection card>
  ...
  <Medium variant="dont">
    ...
    Display more than one primary action with a single view.
