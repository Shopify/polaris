...
![A collection of examples of add actions in the page header, in a list, and
  ...
  <Medium variant="do">
    ...
    Place add actions at the bottom of lists unless the list will likely be long like a table or a list of selected resources.
  ...
  <Medium variant="do">
    ...
    Place add actions in the header in long lists of selected resources.
  ...
  <Medium variant="do">
    ...
    Place add actions associated with a table in the table, card or page header.
...
<LayoutSection card>
  ...
  <Medium variant="do">
    ...
    Show copy actions on hover when a merchant is using a cursor to navigate. See the [copy to clipboard](https://storybook.polaris.shopify.com/?path=/story/all-components-button--copy-to-clipboard) example.
...
<LayoutSection card>
  ...
  <Medium variant="do">
    ...
    Place list item delete actions inline to the right. Default to  a tertiary icon button with the delete icon.
  ...
  <Medium variant="do">
    ...
    <video width="100%" height="auto" controls playsInline muted loop>
      <source
        ...
        type="video/mp4"
      />
      Display list item delete actions on hover to avoid overwhelming the merchant. Only use hover interactions when the merchant is using a cursor to navigate.
    </video>
...
<LayoutSection card>
  ...
  <Medium variant="do">
    ...
    Show remove actions on hover on non touch enabled devices.
