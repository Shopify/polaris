...
<LayoutSection card>
  ...
  <Medium variant="do">
    ...
    Show copy actions on hover on desktop. See the [copy to clipboard](https://storybook.polaris.shopify.com/?path=/story/all-components-button--copy-to-clipboard) example.
  ...
  <Medium variant="do">
    ...
    <video width="100%" height="auto" controls playsInline muted loop>
      <source
        ...
        type="video/mp4"
      />
      Display list item delete actions on hover on desktop devices.
    </video>
...
<LayoutSection card>
  ...
  <Medium variant="do">
    ...
    Show remove actions on hover on desktop devices.
