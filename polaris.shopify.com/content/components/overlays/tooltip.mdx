...
- To make helpful content more visible to merchants, use the help text portions of form components such as [text fields](/components/selection-and-input/text-field), [footer help](/components/navigation/footer-help), or [an inline link to help](/components/link)
