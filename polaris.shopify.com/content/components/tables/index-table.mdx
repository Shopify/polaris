...
examples:
  ...
  - fileName: index-table-with-nested-rows-borderless.tsx
    title: With nested rows borderless
    description: An index table with borderless nested rows. Use to present hierarchical or related data in a structured manner with enhanced visualisation.
