...
- Support [customized index rows and columns](/components/lists/resource-item)
- Include bulk actions so merchants can act on multiple objects at once
- Support sorting and [filtering](/components/selection-and-input/filters) of long lists
...
- [Customize the content and layout](/components/lists/resource-item) of their items rows to surface information to support merchants’ needs.
- Support sorting if the list can be long, and especially if different merchant tasks benefit from different sort orders.
- Support [filtering](/components/selection-and-input/filters) if the list can be long.
...
- Numeric cells and titles should be right aligned with the [Text](/components/typography/text) component
- Numeric cells should use the numeric style with the [Text](/components/typography/text) component
...
- Follow the [content guidelines for filter options and applied filters](/components/selection-and-input/filters#content-guidelines)
...
- To display a simple list of related content, [use the list component](/components/lists)
