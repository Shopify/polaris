...
The resource item component must be wrapped in the [resource list](/components/resource-list) component.
...
- Provide [shortcut actions](/components/lists/resource-item?example=resource-item-with-shortcut-actions) for quick access to frequent actions from the resource’s details page.
...
- Avoid colons.
- [Shortcut actions](/components/lists/resource-item?example=resource-item-with-shortcut-actions) don’t need to follow the full verb + noun formula for buttons.
