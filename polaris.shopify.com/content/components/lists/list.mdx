...
- To create a list of checkboxes or radio buttons, [use the choice list component](/components/choice-list)
- To present a collection of objects of the same type such as customers, products, or orders, [use the resource list component](/components/resource-list)
- When text labels for each item are useful for describing the content, [use the Description List component](/components/description-list)
...
To group items for layout only, consider using the [vertical stack component](/components/layout-and-structure/vertical-stack).
