...
- Be placed on its own inside a container. Usually the container behaves like a menu, as it does with [popover](/components/overlays/popover). Don’t place other components within the same container.
...
- To render a list of actions,
  [use the action list component](/components/action-list)
- To create a list of grouped radio buttons or checkboxes,
  [use the choice list component](/components/choice-list)
...
Controls in simple option lists are [buttons](/components/actions/button), and controls in multiple option lists are [checkboxes](/components/checkbox).
