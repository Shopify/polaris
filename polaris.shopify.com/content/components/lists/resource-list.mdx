...
- Support [customized list items](/components/resource-item)
...
- ResourceList
- [ResourceItem](/components/resource-item) or a customized list item
...
If your use case is more about visualizing or analyzing data, use the [data table component](/components/tables/data-table). If your use case is more about finding and taking action on objects, use a resource list.
...
- [Customize the content and layout](/components/lists/resource-item#content-guidelines) of their list items to support merchants’ needs.
...
- Use the [skeleton page](/components/skeleton-page) component on initial page load for the rest of the page if the loading prop is true and items are processing.
...
- To present structured data for comparison and analysis, like when helping merchants to gain insights or review analytics, use the [data table component](/components/tables/data-table)
