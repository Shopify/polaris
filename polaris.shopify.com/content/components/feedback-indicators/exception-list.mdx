...
- Use the appropriate [color](/design/colors) to suit the tone of the message
...
If placed next to an item in a [resource list](/components/lists/resource-list), exceptions lists should:
...
- To display an error at the top of a page, or to indicate multiple errors in a form, use the [banner](/components/feedback-indicators/banner) component
- Exceptions lists are often used in the [resource list](/components/lists/resource-list) component to display conditional content
