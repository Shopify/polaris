...
- Not be used for marketing information or upsell—[use callout cards](/components/callout-card) instead.

To learn about writing helpful and accessible error message text, see the guidelines for [error messages](/content/error-messages).

### Title

Banner titles should follow the content guidelines for [headings](/components/deprecated/heading) and [subheadings](/components/deprecated/subheading).
...
- To inform merchants about a new feature or opportunity, [use callout cards](/components/callout-card)
- To group similar concepts together in the interface, [use a card](/components/layout-and-structure/card)
...
Always include [inline error](/components/inline-error) messages for specific form fields so that merchants know what to do in context as they correct their mistakes.

To learn about creating helpful and accessible error message text, see the guidelines for [error messages](/content/error-messages).
