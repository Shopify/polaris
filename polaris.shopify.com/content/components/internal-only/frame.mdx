...
<<<<<<<< HEAD:polaris.shopify.com/content/components/deprecated/frame.mdx
category: Deprecated
========
category: Internal only
>>>>>>>> internal-only-with-auth:polaris.shopify.com/content/components/internal-only/frame.mdx
keywords:
  - navigation
  - nav
  - links
