...
<<<<<<<< HEAD:polaris.shopify.com/content/components/deprecated/loading.mdx
category: Deprecated
========
category: Internal only
>>>>>>>> internal-only-with-auth:polaris.shopify.com/content/components/internal-only/loading.mdx
keywords:
  - spinner
  - loader
  - loading
