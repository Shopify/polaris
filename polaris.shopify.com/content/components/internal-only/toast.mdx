...
<<<<<<<< HEAD:polaris.shopify.com/content/components/deprecated/toast.mdx
category: Deprecated
========
category: Internal only
>>>>>>>> internal-only-with-auth:polaris.shopify.com/content/components/internal-only/toast.mdx
keywords:
  - toast
  - flash message
  - snackbar
