...
<StatusBanner status={frontmatter.status}>
  If you are building a Shopify Application you should use the [App Bridge Modal
  API](https://shopify.dev/docs/api/app-bridge-library/reference/modal).
  Internal only components will be removed in future major versions of Polaris.
</StatusBanner>
