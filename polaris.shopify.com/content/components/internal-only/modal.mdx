...
<<<<<<<< HEAD:polaris.shopify.com/content/components/deprecated/modal.mdx
category: Deprecated
========
category: Internal only
>>>>>>>> internal-only-with-auth:polaris.shopify.com/content/components/internal-only/modal.mdx
keywords:
  - modal
  - src
  - open
