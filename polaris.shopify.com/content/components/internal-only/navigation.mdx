---
title: Navigation
<<<<<<<< HEAD:polaris.shopify.com/content/components/deprecated/navigation.mdx
category: Deprecated
========
category: Internal only
>>>>>>>> internal-only-with-auth:polaris.shopify.com/content/components/internal-only/navigation.mdx
keywords:
  - navigation
  - nav
  - links
