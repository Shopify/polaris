...
<<<<<<<< HEAD:polaris.shopify.com/content/components/deprecated/top-bar.mdx
category: Deprecated
========
category: Internal only
>>>>>>>> internal-only-with-auth:polaris.shopify.com/content/components/internal-only/top-bar.mdx
keywords:
  - global chrome
  - global features
  - topbar
