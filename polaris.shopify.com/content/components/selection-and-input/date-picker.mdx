...
<TipBanner title="Tip">
  Check out the [new patterns section](/patterns) to learn how merchants prefer
  to select dates in different scenarios!
</TipBanner>
...
- Follow [date format guidelines](/patterns/date-picking/single-date)
...
- [Date picking](/patterns/date-picking/single-date)
