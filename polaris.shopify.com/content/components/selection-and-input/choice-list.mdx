...
- To build a group of radio buttons or checkboxes with a custom layout, use the [radio button component](/components/radio-button) or [checkbox component](/components/checkbox)
...
The choice list component uses the accessibility features of the [checkbox](/components/selection-and-input/checkbox#accessibility) and [radio button](/components/selection-and-input/radio-button#accessibility) components.
