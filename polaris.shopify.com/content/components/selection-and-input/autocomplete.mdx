...
The input field for autocomplete should follow the [content guidelines](/components/selection-and-input/text-field#content-guidelines) for text fields.

---

## Related components

- For an input field without suggested options, [use the text field component](/components/layout-and-structure/form-layout)
- For a list of selectable options not linked to an input field, [use the option list component](/components/selection-and-input/inline-error)
- For a text field that triggers a popover, [use the combo box component](/components/selection-and-input/select)
