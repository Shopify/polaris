...
examples:
  ...
  - fileName: drop-zone-drag-and-drop-only.tsx
    title: With custom modal and drag-and-drop only
    description:
      Use to delegate file uploading to child element which serves as the modal activator and provides
