...
- To see how pagination is used on a page, see the [page component](/components/layout-and-structure/page)
- To add primary and secondary calls to action at the bottom of a page, see the [page actions component](/components/actions/page-actions)
- The [resource list component](/components/resource-list) is often combined with pagination to handle long lists of resources such as orders or customers
