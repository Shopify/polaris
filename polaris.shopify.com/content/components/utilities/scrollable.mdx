...
Scrollable containers are cards with scrolling functionality, and should follow the [content guidelines](/components/layout-and-structure/card#best-practices) for cards.
