...
Form section titles should follow the content guidelines for [headings](/components/deprecated/heading) and [subheadings](/components/deprecated/subheading).
...
- To arrange the largest sections of a page, [use the layout component](/components/layout-and-structure/layout)
