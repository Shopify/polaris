...
examples:
  ...
  - fileName: form-layout-nested-groups.tsx
    title: Nested groups
    description: Use to horizontally and vertically arrange closely related fields within a larger form. Works best for arranging familiar fields inline within a larger field group, such as a row of city, state, and zip code fields in an address field group. Field groups wrap automatically on smaller screens.
