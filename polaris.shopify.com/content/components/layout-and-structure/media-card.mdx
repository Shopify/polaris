...
Media card titles should follow the content guidelines for [headings](/components/deprecated/heading) and [subheadings](/components/deprecated/subheading).
...
- To create a video card, [use the video thumbnail component](/components/video-thumbnail)
- To group similar concepts and tasks together, [use the card component](/components/layout-and-structure/card)
- To create page-level layout, [use the layout component](/components/layout-and-structure/layout)
- To explain a feature that merchants haven’t tried yet, [use the empty state component](/components/layout-and-structure/empty-state)
...
Use [actionable language](/content/) to ensure that the purpose of the media card is clear to all merchants, including those with issues related to reading and language.
