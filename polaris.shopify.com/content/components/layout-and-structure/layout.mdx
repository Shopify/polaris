...
Content from cards should follow the content guidelines for [cards](/components/layout-and-structure/legacy-card#content-guidelines).

### Annotated section titles

Annotated section titles should follow the content guidelines for [headings](/components/deprecated/heading) and [subheadings](/components/deprecated/subheading).
...
- To visually group content in a layout section, [use the card component](/components/layout-and-structure/card)
- To lay out a set of smaller components in a row, [use the vertical stack component](/components/layout-and-structure/vertical-stack)
- To lay out form fields, [use the form layout component](/components/form-layout)
