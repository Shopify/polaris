...
- Follow the content guidelines for [headings](/components/deprecated/heading) and [subheadings](/components/deprecated/subheading).
...
- To create page-level layout, [use the layout component](/components/layout-and-structure/layout)
- To highlight a Shopify feature, [use the callout card component](/components/callout-card)
