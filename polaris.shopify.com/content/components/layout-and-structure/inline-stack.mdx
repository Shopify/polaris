...
examples:
  ...
  - fileName: inline-stack-with-gap.tsx
    title: Gap
    description: >-
      Control the horizontal and vertical space between children using the `gap` prop. The `gap` prop supports responsive spacing with the [Breakpoints tokens](/tokens/breakpoints).
  ...
  - fileName: inline-stack-with-direction.tsx
    title: Direction
    description: >-
      Control the horizontal direction of children using the `direction` prop. The `direction` prop supports responsive spacing with the [Breakpoints tokens](/tokens/breakpoints).
...
- To create the large-scale structure of pages, [use the InlineGrid component](/components/layout-and-structure/inline-grid)
- To display elements vertically, [use the BlockStack component](/components/layout-and-structure/block-stack)
