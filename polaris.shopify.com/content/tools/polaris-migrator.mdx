...
{/* Was a shields.io version badge. These archived docs make no off-origin
requests, and a live version badge on a frozen page would be misleading anyway,
so it's a plain link to the package. */}

[@shopify/polaris-migrator on npm](https://www.npmjs.com/package/@shopify/polaris-migrator)
