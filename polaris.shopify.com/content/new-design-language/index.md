...
- _recommended_ – Use [`Card`](https://polaris.shopify.com/components/layout-and-structure/card) and [`BlockStack`](https://polaris.shopify.com/components/layout-and-structure/vertical-stack) to compose a new card layout
