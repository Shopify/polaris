// the css-type package types are based on this data set
// We need this data set to create an intersection between this and the webref data set
// So we don't end up coercing the wrong types.
...
export default {
  ...
  'border-block': {
    ...
    percentages: 'no',
    groups: ['CSS Logical Properties'],
    initial: ['border-block-width', 'border-block-style', 'border-block-color'],
    appliesto: 'allElements',
    computed: [
      'border-block-width',
      'border-block-style',
